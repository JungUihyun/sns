    ...
    <div class="posting">
        <div class="write">
            <form action="/write" method="post" id="writeForm" enctype="multipart/form-data" >
                <input type="text" name="link" class="link" placeholder="링크 주소를 입력하세요 예) 'www.gmsgondr.net'">
                ...
                <div class="media">
                    <div class="type">
                        <ul>
                            ...
                            <li>
                                <input type="file" name="" style="opacity: 0;" class="input_menu upLink" multiple>
                                <a href="" class="link_menu">
                                    <span class="txt_menu">
                ...
                <div class="selectBox" style="display: none; margin-right: 50px;">
                    <select name="setDistance" id="setDistance">
                        <option value="">글 공개범위</option>
                        <option value="1">전체공개</option>
                        <option value="2">친구공개</option>
                        <option value="3">나만 보기</option>
                    </select>
                    <select name="setCDistance" id="setCDistance">
                        <option value="">댓글 작성권한</option>
                        <option value="1">모두 가능</option>
        ...
        <?php foreach($list as $item) { ?>
            ...
            <?php } else { ?>
                <div class="section">
                    <div class="post_profile" onclick="location.href='/profile/<?= $item->uidx ?>'">
